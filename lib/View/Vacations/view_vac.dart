// ignore_for_file: prefer_const_constructors, camel_case_types, avoid_unnecessary_containers, non_constant_identifier_names
...
import 'package:nko_flutter/View/Widget/Vacations/cardVac.dart';
import '../../../Controller/bindings.dart';
import '../../../Core/class/statusrequest.dart';
import '../../../Controller/viewVaccontroller.dart';

class View_Vac extends StatelessWidget {
  const View_Vac({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Get.off(() => Add_Vac(), binding: Binding_vac_add());
          },
          child: FaIcon(FontAwesomeIcons.plus)),
      drawer: Drawer_all(),
      body: ListView(
        children: [
          GetBuilder<VacController>(builder: (controller) {
            if (controller.statusRequest == StatusRequest.loding) {
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (context, i) {
                    return CardVacation(
                      t: Vacations.fromJson(controller.data[i]),
                    );
                  });
            }
          }),
